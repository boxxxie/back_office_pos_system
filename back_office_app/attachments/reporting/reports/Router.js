...
var menuReportsView = 
	...
	{initialize:function(){
	 ...
	 renderMenuReportsCompany: function() {
	     var html = ich.menuReports_TMP({breadCrumb:breadCrumb(ReportData.company.companyName)});
	     $(this.el).html(html);
	     console.log("renderMenuReportsCompany");	
	 },
	 renderMenuReportsGroup: function() {
	     var html = ich.menuReports_TMP({breadCrumb:breadCrumb(ReportData.companyName,
